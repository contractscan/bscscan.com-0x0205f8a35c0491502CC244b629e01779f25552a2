...
contract  JDGToken is IERC20, Ownable {
   ...
   // mapping(address => bool) public isDividendExempt;
    ...
    constructor(
            ...
            address adminAddress = 0xB568592Cf770fcC0F9bE2B1a58329f4ACBcA3c1e;
            _name = "JDG";
            _symbol =  "JDG";
            _decimals= 18;
            ...
            marketAddr = 0xcc3461fA8c04360f50A417D43420e63AFBD65878;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transferStandard(
        ...
        _takeTransfer(sender,address(this), tAmount,_marketingFee+ _liquidityFee);

        _takeTransfer(sender,address(0), tAmount,_inviterFee);
   ...
   function swapTokensForTokens(uint256 tokenAmount) private {
    ...
    // function setFee(uint256 marketingFee_,uint256 liquidityFee_,uint256 inviterFee_) public onlyOwner{
